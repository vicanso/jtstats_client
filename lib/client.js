...
var url = require('url');
var debug = require('debug')('jt.stats_client');
...
function Client(options){
  ...
  if(options.uri){
    var urlInfo = url.parse(options.uri);
    this._host = urlInfo.hostname;
    this._port = urlInfo.port;
  }
  debug('host:%s, port:%s', this._host, this._port);
}
